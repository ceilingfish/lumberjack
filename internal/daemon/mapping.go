...
// SetupSteps is left unset here — computing it requires reading the trusted
// `.lumberjack.yml` from git, so callers that want it set it afterwards via
// Server.decorateSetupSteps.
